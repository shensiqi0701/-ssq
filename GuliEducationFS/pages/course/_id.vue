      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img height="357px" width="650px" :src="courseInfo.cover" :alt="courseInfo.title" class="dis c-v-pic">
          </section>
        </article>
                ...
                <div>
                  ...
                  <div class="course-txt-body-wrap">
                    <section class="course-txt-body">
                      <!-- v-html标签，可以使内容中的html标签翻译，而不是原样输出 -->
  ...
  //  },
   ...
   methods:{
     //获取课程详情信息
      ...
      //获取分页评论
       initComment(){
         commentApi.getCommentPageList(this.page, this.limit, this.courseId).then(response => {
      ...
      //分页跳转
       gotoPage(page){
          commentApi.getCommentPageList(page, this.limit,this.courseId).then(response => {
              this.data = response.data.data
          })
      },
