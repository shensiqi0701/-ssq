  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item class="input-prepend restyle no-radius" prop="email" :rules="[{ required: true, message: '请输入QQ邮箱', trigger: 'blur' },{validator: checkEmail, trigger: 'blur'}]">
          <div>
            <el-input type="text" placeholder="QQ邮箱(用于接收验证码)" v-model="params.email"/>
            <i class="iconfont icon-phone"/>
          </div>
        </el-form-item>
